...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const message = err?.response?.data?.detail || err?.response?.data?.message ||"An unexpected error occurred"
      toast({
        title: 'Registration Failed',
        description: message,
        variant: 'destructive',
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-primary/5 p-4">
      ...
      <Card className="w-full max-w-md animate-fade-in glass-effect">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription>Register as an admin to manage support tickets</CardDescription>
        </CardHeader>
